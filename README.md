...
.
|-- README.md
`-- Designcospaceregistrationpage-main/
    |-- backend/
    |-- frontend/
    |-- database/
    |-- docker-compose.yml
...
All application source code is inside:
...
- View operational reports and runtime settings.
...
```txt
Designcospaceregistrationpage-main/backend/src/main/resources/db/migration/
```
...
```bash
cd Designcospaceregistrationpage-main
...
```bash
cd Designcospaceregistrationpage-main/backend
mvn test
```
...
```txt
Designcospaceregistrationpage-main/.github/workflows/ci.yml
```
